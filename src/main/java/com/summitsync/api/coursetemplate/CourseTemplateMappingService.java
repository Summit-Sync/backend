...
public class CourseTemplateMappingService {
    ...
    public CourseTemplate mapPostCourseTemplateDtoToCourseTemplate(PostCourseTemplateDto dto){
        return new CourseTemplate(dto.getAcronym(), dto.getNumberOfDates(),dto.getDescription(),dto.getQualificationList(),dto.getNumberOfParticipants(), dto.getNumberOfWaitList(), dto.getNumberOfTrainers(),dto.getPriceList());
    }
