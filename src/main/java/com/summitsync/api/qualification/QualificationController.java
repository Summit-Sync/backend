...
public class QualificationController {
    ...
    public ResponseEntity<QualificationDto> giveMultipleTrainersQualification(@PathVariable("id") long id, @RequestBody List<Long> ids, JwtAuthenticationToken jwt) {
        var qualification = this.qualificationService.findById(id);
        return new ResponseEntity<>(this.qualificationService.addTrainerList(qualification, ids, jwt), HttpStatus.OK);
    }
}
