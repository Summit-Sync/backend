package com.summitsync.api.googlecalendar;
...
public class GoogleCalendar {
    private static final String APPLICATION_NAME = "SummitSync";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        InputStream in = SummitSyncApplication.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
